...
public class CCOthersIssue extends BaseFragment
    ...
    public View onCreateView(
        ...
        return inflater.inflate(R.layout.cc_others, container, false);
    }
    @Override
    ...
    private boolean validateWdRequestId() {
        ...
        TextView mailUI = view.findViewById(R.id.ccOthersET);
        String str = mailUI.getText().toString().trim();
        String result = Utils.fullValidate(str, "Description", false, -1, 250, false);
    ...
    private void handleTextWatchers(boolean add) {
        ...
        TextView textView = view.findViewById(R.id.ccOthersET);
        if (add) {
