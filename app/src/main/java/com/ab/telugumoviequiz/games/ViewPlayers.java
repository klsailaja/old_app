...
public class ViewPlayers extends DialogFragment implements View.OnClickListener {
    private final Context context;
    private final int gameViewId;
    private List<String> list = new ArrayList<>();

    public ViewPlayers(Context context, int gameViewId) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        currentPlayersCount.setVisibility(View.GONE);

        TextView creditStatus = root.findViewById(R.id.creditStatus);
        creditStatus.setVisibility(View.GONE);

        TextView totalCountLabel = root.findViewById(R.id.totalCount);
        long serverId = UserDetails.getInstance().getUserProfile().getServerIndex();
        String text = "Enrolled Players for GameId#: " + gameViewId
                + " connected to server Id: " + serverId + ". Please note that many servers may run";
        ...
        String heading1 = resources.getString(R.string.view_players_sno);
        String heading2 = resources.getString(R.string.view_players_name);
